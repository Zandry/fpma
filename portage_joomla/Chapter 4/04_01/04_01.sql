...
--
-- Host: localhost
-- Generation Time: Oct 29, 2012 at 09:55 PM
...
--
-- Table structure for table `rmpo6_assets`
--

CREATE TABLE IF NOT EXISTS `rmpo6_assets` (
...
--
-- Dumping data for table `rmpo6_assets`
--

INSERT INTO `rmpo6_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(35, 8, 20, 21, 2, 'com_content.category.8', 'Products', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(36, 8, 22, 27, 2, 'com_content.category.9', 'News & Info', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(37, 36, 23, 24, 3, 'com_content.category.10', 'Solar', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(38, 36, 25, 26, 3, 'com_content.category.11', 'Press Releases', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(39, 8, 28, 29, 2, 'com_content.category.12', 'About', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}');

-- --------------------------------------------------------

--
-- Table structure for table `rmpo6_associations`
--

CREATE TABLE IF NOT EXISTS `rmpo6_associations` (
...
--
-- Table structure for table `rmpo6_banners`
--

CREATE TABLE IF NOT EXISTS `rmpo6_banners` (
...
--
-- Table structure for table `rmpo6_banner_clients`
--

CREATE TABLE IF NOT EXISTS `rmpo6_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `rmpo6_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `rmpo6_banner_tracks` (
...
--
-- Table structure for table `rmpo6_categories`
--

CREATE TABLE IF NOT EXISTS `rmpo6_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `rmpo6_categories`
--

INSERT INTO `rmpo6_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
(8, 35, 1, 13, 14, 1, 'products', 'com_content', 'Products', 'products', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 158, '2012-10-29 21:44:07', 0, '0000-00-00 00:00:00', 0, '*', 1),
(9, 36, 1, 15, 20, 1, 'news-info', 'com_content', 'News & Info', 'news-info', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 158, '2012-10-29 21:44:18', 0, '0000-00-00 00:00:00', 0, '*', 1),
(10, 37, 9, 16, 17, 2, 'news-info/solar', 'com_content', 'Solar', 'solar', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 158, '2012-10-29 21:44:25', 158, '2012-10-29 21:45:56', 0, '*', 1),
(11, 38, 9, 18, 19, 2, 'news-info/press-releases', 'com_content', 'Press Releases', 'press-releases', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 158, '2012-10-29 21:44:32', 158, '2012-10-29 21:46:33', 0, '*', 1),
(12, 39, 1, 21, 22, 1, 'about', 'com_content', 'About', 'about', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 158, '2012-10-29 21:44:42', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `rmpo6_contact_details`
--

CREATE TABLE IF NOT EXISTS `rmpo6_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `rmpo6_content`
--

CREATE TABLE IF NOT EXISTS `rmpo6_content` (
...
--
-- Table structure for table `rmpo6_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `rmpo6_content_frontpage` (
...
--
-- Table structure for table `rmpo6_content_rating`
--

CREATE TABLE IF NOT EXISTS `rmpo6_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `rmpo6_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `rmpo6_core_log_searches` (
...
--
-- Table structure for table `rmpo6_extensions`
--

CREATE TABLE IF NOT EXISTS `rmpo6_extensions` (
...
--
-- Dumping data for table `rmpo6_extensions`
--

INSERT INTO `rmpo6_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
--
-- Table structure for table `rmpo6_finder_filters`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_filters` (
...
--
-- Table structure for table `rmpo6_finder_links`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_links` (
...
--
-- Table structure for table `rmpo6_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_links_terms0` (
...
--
-- Table structure for table `rmpo6_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `rmpo6_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `rmpo6_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `rmpo6_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `rmpo6_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `rmpo6_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `rmpo6_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `rmpo6_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `rmpo6_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `rmpo6_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `rmpo6_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `rmpo6_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `rmpo6_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `rmpo6_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `rmpo6_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `rmpo6_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `rmpo6_finder_taxonomy`
--

INSERT INTO `rmpo6_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `rmpo6_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `rmpo6_finder_terms`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_terms` (
...
--
-- Table structure for table `rmpo6_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `rmpo6_finder_terms_common`
--

INSERT INTO `rmpo6_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `rmpo6_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `rmpo6_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `rmpo6_finder_types`
--

CREATE TABLE IF NOT EXISTS `rmpo6_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `rmpo6_languages`
--

CREATE TABLE IF NOT EXISTS `rmpo6_languages` (
...
--
-- Dumping data for table `rmpo6_languages`
--

INSERT INTO `rmpo6_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `rmpo6_menu`
--

CREATE TABLE IF NOT EXISTS `rmpo6_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `rmpo6_menu`
--

INSERT INTO `rmpo6_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `rmpo6_menu_types`
--

CREATE TABLE IF NOT EXISTS `rmpo6_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `rmpo6_menu_types`
--

INSERT INTO `rmpo6_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `rmpo6_messages`
--

CREATE TABLE IF NOT EXISTS `rmpo6_messages` (
...
--
-- Table structure for table `rmpo6_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `rmpo6_messages_cfg` (
...
--
-- Table structure for table `rmpo6_modules`
--

CREATE TABLE IF NOT EXISTS `rmpo6_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `rmpo6_modules`
--

INSERT INTO `rmpo6_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `rmpo6_modules_menu`
--

CREATE TABLE IF NOT EXISTS `rmpo6_modules_menu` (
...
--
-- Dumping data for table `rmpo6_modules_menu`
--

INSERT INTO `rmpo6_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `rmpo6_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `rmpo6_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `rmpo6_overrider`
--

CREATE TABLE IF NOT EXISTS `rmpo6_overrider` (
...
--
-- Table structure for table `rmpo6_redirect_links`
--

CREATE TABLE IF NOT EXISTS `rmpo6_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `rmpo6_schemas`
--

CREATE TABLE IF NOT EXISTS `rmpo6_schemas` (
...
--
-- Dumping data for table `rmpo6_schemas`
--

INSERT INTO `rmpo6_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.0.1');

-- --------------------------------------------------------

--
-- Table structure for table `rmpo6_session`
--

CREATE TABLE IF NOT EXISTS `rmpo6_session` (
...
--
-- Dumping data for table `rmpo6_session`
--

INSERT INTO `rmpo6_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('mro9tt09le1q7595vkpbnvfa21', 0, 0, '1351547088', '__default|a:8:{s:15:"session.counter";i:18;s:19:"session.timer.start";i:1351537759;s:18:"session.timer.last";i:1351546532;s:17:"session.timer.now";i:1351547087;s:22:"session.client.browser";s:72:"Mozilla/5.0 (Windows NT 6.1; WOW64; rv:16.0) Gecko/20100101 Firefox/16.0";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":1:{s:5:"users";O:8:"stdClass":1:{s:5:"login";O:8:"stdClass":1:{s:4:"form";O:8:"stdClass":2:{s:4:"data";a:0:{}s:6:"return";s:17:"http://localhost/";}}}}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"158";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:17:"info@kineteco.com";s:8:"password";s:65:"1afb4ee29cde845196b3c8888a370497:s3an2nmyUiOFrjNgKpMRIGKt7XfB18J4";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2012-10-29 18:43:34";s:13:"lastvisitDate";s:19:"2012-10-29 20:52:34";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"dcaa387956166c4bbb2eebbd827ee1bd";}', 158, 'admin'),
('tqm09cef3tmmpfdhqju3fe2q41', 1, 0, '1351547638', '__default|a:8:{s:15:"session.counter";i:118;s:19:"session.timer.start";i:1351543553;s:18:"session.timer.last";i:1351547636;s:17:"session.timer.now";i:1351547638;s:22:"session.client.browser";s:72:"Mozilla/5.0 (Windows NT 6.1; WOW64; rv:16.0) Gecko/20100101 Firefox/16.0";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":6:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}s:10:"com_config";O:8:"stdClass":1:{s:6:"config";O:8:"stdClass":1:{s:6:"global";O:8:"stdClass":1:{s:4:"data";N;}}}s:5:"media";O:8:"stdClass":1:{s:4:"list";O:8:"stdClass":1:{s:6:"layout";s:6:"thumbs";}}s:14:"com_categories";O:8:"stdClass":2:{s:10:"categories";O:8:"stdClass":2:{s:6:"filter";O:8:"stdClass":1:{s:9:"extension";s:11:"com_content";}s:7:"content";O:8:"stdClass":5:{s:6:"search";s:0:"";s:6:"filter";O:8:"stdClass":4:{s:5:"level";i:0;s:6:"access";i:0;s:9:"published";s:0:"";s:8:"language";s:0:"";}s:10:"limitstart";i:0;s:8:"ordercol";s:5:"a.lft";s:9:"orderdirn";s:3:"asc";}}s:4:"edit";O:8:"stdClass":1:{s:8:"category";O:8:"stdClass":2:{s:4:"data";N;s:2:"id";a:0:{}}}}s:6:"global";O:8:"stdClass":1:{s:4:"list";O:8:"stdClass":1:{s:5:"limit";i:20;}}}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"158";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:17:"info@kineteco.com";s:8:"password";s:65:"1afb4ee29cde845196b3c8888a370497:s3an2nmyUiOFrjNgKpMRIGKt7XfB18J4";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2012-10-29 18:43:34";s:13:"lastvisitDate";s:19:"2012-10-29 20:45:53";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"06ea99037331be6e021e56f7a6df859d";}', 158, 'admin');

-- --------------------------------------------------------

--
-- Table structure for table `rmpo6_template_styles`
--

CREATE TABLE IF NOT EXISTS `rmpo6_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `rmpo6_template_styles`
--

INSERT INTO `rmpo6_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `rmpo6_updates`
--

CREATE TABLE IF NOT EXISTS `rmpo6_updates` (
...
--
-- Dumping data for table `rmpo6_updates`
--

INSERT INTO `rmpo6_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
...
(15, 3, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '3.0.1.1', '', 'http://update.joomla.org/language/details3/it-IT_details.xml', ''),
(16, 3, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '3.0.1.1', '', 'http://update.joomla.org/language/details3/ja-JP_details.xml', ''),
(17, 3, 0, 'Korean', '', 'pkg_ko-KR', 'package', '', 0, '3.0.0.3', '', 'http://update.joomla.org/language/details3/ko-KR_details.xml', ''),
(18, 3, 0, 'Kurdish Sorani', '', 'pkg_ckb-IQ', 'package', '', 0, '3.0.1.1', '', 'http://update.joomla.org/language/details3/ckb-IQ_details.xml', ''),
(19, 3, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '3.0.1.1', '', 'http://update.joomla.org/language/details3/lv-LV_details.xml', ''),
(20, 3, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.0.1.1', '', 'http://update.joomla.org/language/details3/mk-MK_details.xml', ''),
(21, 3, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.0.0.1', '', 'http://update.joomla.org/language/details3/fa-IR_details.xml', ''),
(22, 3, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '3.0.1.1', '', 'http://update.joomla.org/language/details3/pl-PL_details.xml', ''),
(23, 3, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.0.1.2', '', 'http://update.joomla.org/language/details3/ru-RU_details.xml', ''),
(24, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.0.1.2', '', 'http://update.joomla.org/language/details3/sk-SK_details.xml', ''),
(25, 3, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '3.0.1.1', '', 'http://update.joomla.org/language/details3/sv-SE_details.xml', ''),
(26, 3, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '3.0.1.1', '', 'http://update.joomla.org/language/details3/sy-IQ_details.xml', ''),
(27, 3, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.0.1.1', '', 'http://update.joomla.org/language/details3/ta-IN_details.xml', ''),
(28, 3, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.0.1.1', '', 'http://update.joomla.org/language/details3/th-TH_details.xml', ''),
(29, 3, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.0.1.1', '', 'http://update.joomla.org/language/details3/tr-TR_details.xml', ''),
(30, 3, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '3.0.1.2', '', 'http://update.joomla.org/language/details3/uk-UA_details.xml', ''),
(31, 3, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.0.1.1', '', 'http://update.joomla.org/language/details3/pt-BR_details.xml', ''),
(32, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.0.0.1', '', 'http://update.joomla.org/language/details3/sr-YU_details.xml', ''),
(33, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.0.1.1', '', 'http://update.joomla.org/language/details3/es-ES_details.xml', ''),
(34, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.0.1.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', ''),
(35, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.0.1.1', '', 'http://update.joomla.org/language/details3/sr-RS_details.xml', ''),
(36, 3, 0, 'Vietnamese', '', 'pkg_vi-VN', 'package', '', 0, '3.0.1.2', '', 'http://update.joomla.org/language/details3/vi-VN_details.xml', ''),
(37, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.0.1.1', '', 'http://update.joomla.org/language/details3/fi-FI_details.xml', '');

-- --------------------------------------------------------

--
-- Table structure for table `rmpo6_update_sites`
--

CREATE TABLE IF NOT EXISTS `rmpo6_update_sites` (
...
--
-- Dumping data for table `rmpo6_update_sites`
--

INSERT INTO `rmpo6_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1351547284),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1351547284),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1351547284);

-- --------------------------------------------------------

--
-- Table structure for table `rmpo6_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `rmpo6_update_sites_extensions` (
...
--
-- Dumping data for table `rmpo6_update_sites_extensions`
--

INSERT INTO `rmpo6_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Table structure for table `rmpo6_usergroups`
--

CREATE TABLE IF NOT EXISTS `rmpo6_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `rmpo6_usergroups`
--

INSERT INTO `rmpo6_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `rmpo6_users`
--

CREATE TABLE IF NOT EXISTS `rmpo6_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `rmpo6_users`
--

INSERT INTO `rmpo6_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(158, 'Super User', 'admin', 'info@kineteco.com', '1afb4ee29cde845196b3c8888a370497:s3an2nmyUiOFrjNgKpMRIGKt7XfB18J4', 0, 1, '2012-10-29 18:43:34', '2012-10-29 21:00:23', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `rmpo6_user_notes`
--

CREATE TABLE IF NOT EXISTS `rmpo6_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `rmpo6_user_profiles`
--

CREATE TABLE IF NOT EXISTS `rmpo6_user_profiles` (
...
--
-- Table structure for table `rmpo6_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `rmpo6_user_usergroup_map` (
...
--
-- Dumping data for table `rmpo6_user_usergroup_map`
--

INSERT INTO `rmpo6_user_usergroup_map` (`user_id`, `group_id`) VALUES
(158, 8);

-- --------------------------------------------------------

--
-- Table structure for table `rmpo6_viewlevels`
--

CREATE TABLE IF NOT EXISTS `rmpo6_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `rmpo6_viewlevels`
--

INSERT INTO `rmpo6_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `rmpo6_weblinks`
--

CREATE TABLE IF NOT EXISTS `rmpo6_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
